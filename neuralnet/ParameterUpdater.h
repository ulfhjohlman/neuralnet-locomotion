...
{
public:
    MomentumUpdater(ScalarType lr, ScalarType mu) : ParameterUpdater(lr) , m_mu(mu) {}
...
public:
    ...
    AdagradUpdater(ScalarType lr, ScalarType epsilon) : ParameterUpdater(lr) , m_epsilon(epsilon) {}
...
public:
    RMSPropUpdater(ScalarType lr, ScalarType epsilon, ScalarType decay_rate)
...
public:
    AdamUpdater(ScalarType lr, ScalarType epsilon, ScalarType b1, ScalarType b2) : ParameterUpdater(lr),
