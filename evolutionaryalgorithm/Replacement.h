...
public:
	...
	//ugliest function of my life
	template<typename T>
	static void linearDeath(Population<T>& population, ThreadsafeQueue< std::unique_ptr< Individual<T> > >& kill_list, int start_index, ScalarType start_survival_rate) {
